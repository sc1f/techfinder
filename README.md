...
- **Controls.**
  ...
  - The controls never cover the camera image, which sits at the top and never moves or resizes: the bottom band always keeps room for the movement controls and the turned meter. On a short screen such as the iPhone SE, the image is a little smaller to make that room.
