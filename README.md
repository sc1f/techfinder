...
- **Landscape.** Hold the phone sideways and the meter and tools stand in a column at the viewer's side: shutter, aperture and ISO, then the tools two by two. Their value lists open turned to read upright. The lens and format pills move to the bottom edge, the lens labels turn smoothly with the phone, and sheets open as rotated glass cards.
