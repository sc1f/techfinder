...
- **Controls.**
  ...
  - The controls stay in the black bands above and below the camera image and never cover it. On a short screen such as the iPhone SE, the image shrinks to leave them room.
...
- **Landscape.** Hold the phone sideways and the meter stands in a column beside the lens row: shutter, aperture and ISO from the viewer's top. Its value lists open turned to read upright. The tool and lens-row icons turn in place, the lens labels turn smoothly with the phone, the movement controls run along the viewer's bottom edge, and sheets open as rotated glass cards.
